...
/**
 * Test for Chain move triggered by one, similar to test AnotherDeadlock.
 */
public class ChainMove {

	public static void main(String[] args) {
		MojaPlansza plansza = new MojaPlansza(11, 9);
		
		Postać p[] = { new Unit(1, 2), new Unit(3, 1), new Unit(2, 3), new Unit(4, 2), new Unit(1, 3) };
		...
		Kierunek dirs[] = {Kierunek.DÓŁ, Kierunek.DÓŁ, Kierunek.PRAWO, Kierunek.GÓRA, Kierunek.GÓRA};
